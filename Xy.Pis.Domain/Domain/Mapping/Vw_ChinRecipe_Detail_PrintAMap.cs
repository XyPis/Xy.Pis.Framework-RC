...
{
    public class Vw_ChinRecipe_Detail_PrintAMap : EntityTypeConfiguration<Vw_ChinRecipe_Detail_PrintA>
    {
        public Vw_ChinRecipe_Detail_PrintAMap()
        {
            // Primary Key
            ...
            this.ToTable("Vw_ChinRecipe_Detail_PrintA");
