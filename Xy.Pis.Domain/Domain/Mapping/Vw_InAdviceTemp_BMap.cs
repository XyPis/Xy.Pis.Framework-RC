...
{
    public class Vw_InAdviceTemp_BMap : EntityTypeConfiguration<Vw_InAdviceTemp_B>
    {
        public Vw_InAdviceTemp_BMap()
        {
            // Primary Key
            this.HasKey(t => new { t.OperDate, t.ID, t.AdviceTime, t.DoctorId, t.LocationId, t.HospId, t.GroupNum, t.ItemId, t.Dosage, t.PriceIn, t.Totality, t.UnitInId, t.IsUrgent, t.IsAttach, t.IsSelf, t.LsSpecialUsage, t.LsExecLoc, t.IsSkin, t.OperTime, t.OperID, t.IsPrinted, t.IsChk, t.IsAuth, t.IsAuthFee, t.IsCancel, t.Memo, t.ExecLocId });
            ...
            this.ToTable("Vw_InAdviceTemp_B");
