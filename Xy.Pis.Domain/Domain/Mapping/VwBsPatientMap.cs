...
{
    public class VwBsPatientMap : EntityTypeConfiguration<VwBsPatient>
    {
        public VwBsPatientMap()
        {
            // Primary Key
            ...
            this.Property(t => t.FamilyOpertime).HasColumnName("FamilyOpertime");
