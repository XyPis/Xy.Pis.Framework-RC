...
{
    public class VwOuExecuteMap : EntityTypeConfiguration<VwOuExecute>
    {
        public VwOuExecuteMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MzRegNo, t.PatientName, t.MzRegId, t.GroupNum, t.NDay, t.NTime, t.ItemName, t.Spec, t.Dosage, t.UnitTakeName, t.UsageName, t.FrequencyName, t.UnitDiagName, t.ItemId, t.PriceDiag, t.Days });
