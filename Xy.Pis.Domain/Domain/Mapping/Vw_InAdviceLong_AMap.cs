...
{
    public class Vw_InAdviceLong_AMap : EntityTypeConfiguration<Vw_InAdviceLong_A>
    {
        public Vw_InAdviceLong_AMap()
        {
            // Primary Key
            this.HasKey(t => new { t.OperDate, t.ID, t.AdviceTime, t.DoctorId, t.LocationId, t.HospId, t.GroupNum, t.ItemId, t.Dosage, t.Totality, t.UnitInId, t.IsAttach, t.IsSelf, t.LsSpecialUsage, t.LsExecLoc, t.IsSkin, t.OperTime, t.OperID, t.IsPrinted, t.IsChk, t.IsEnd, t.IsAuth, t.Memo });
            ...
            this.ToTable("Vw_InAdviceLong_A");
