...
{
    public class HuSplitOutMap : EntityTypeConfiguration<HuSplitOut>
    {
        public HuSplitOutMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.BsItem)
                .WithMany(t => t.HuSplitOuts)
                .HasForeignKey(d => d.ItemId);
            this.HasRequired(t => t.BsUnit)
                .WithMany(t => t.HuSplitOuts)
                .HasForeignKey(d => d.UnitId);
            this.HasRequired(t => t.HuSplit)
                .WithMany(t => t.HuSplitOuts)
