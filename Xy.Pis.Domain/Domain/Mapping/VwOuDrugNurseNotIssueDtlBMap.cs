...
{
    public class VwOuDrugNurseNotIssueDtlBMap : EntityTypeConfiguration<VwOuDrugNurseNotIssueDtlB>
    {
        public VwOuDrugNurseNotIssueDtlBMap()
        {
            // Primary Key
            ...
            this.ToTable("VwOuDrugNurseNotIssueDtlB");
