...
{
    public class VwHustoresRemainMap : EntityTypeConfiguration<VwHustoresRemain>
    {
        public VwHustoresRemainMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.InBatchNo, t.ItemId, t.HouseId, t.RoomName, t.UnitName, t.CompanyName, t.StockPrice, t.RetailPrice, t.StockNum, t.InstoreNum, t.StoreDate, t.ItemName, t.Spec });
