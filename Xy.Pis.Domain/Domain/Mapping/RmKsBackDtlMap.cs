...
{
    public class RmKsBackDtlMap : EntityTypeConfiguration<RmKsBackDtl>
    {
        public RmKsBackDtlMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.BsItem)
                .WithMany(t => t.RmKsBackDtls)
                .HasForeignKey(d => d.ItemId);
            this.HasRequired(t => t.BsUnit)
                .WithMany(t => t.RmKsBackDtls)
                .HasForeignKey(d => d.UnitId);
            this.HasRequired(t => t.RmKsBack)
                .WithMany(t => t.RmKsBackDtls)
