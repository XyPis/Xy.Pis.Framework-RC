...
{
    public class VwOuHosInfoMap : EntityTypeConfiguration<VwOuHosInfo>
    {
        public VwOuHosInfoMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.MzRegNo, t.PatientName, t.PatId, t.Sex, t.RegTime, t.IsPriority, t.RegTypeId, t.RegDept, t.PatTypeId, t.GetTallyType, t.GetTallyTypeName, t.IsInPatient, t.DiagStatus, t.LineOrder });
