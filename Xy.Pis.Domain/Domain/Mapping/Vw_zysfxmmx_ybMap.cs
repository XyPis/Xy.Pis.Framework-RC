...
{
    public class Vw_zysfxmmx_ybMap : EntityTypeConfiguration<Vw_zysfxmmx_yb>
    {
        public Vw_zysfxmmx_ybMap()
        {
            // Primary Key
            this.HasKey(t => new { t.数量, t.金额, t.日期, t.日期字符, t.性别 });
