...
{
    public class RmOutEmployeeDtlMap : EntityTypeConfiguration<RmOutEmployeeDtl>
    {
        public RmOutEmployeeDtlMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.HasRequired(t => t.BsItem)
                .WithMany(t => t.RmOutEmployeeDtls)
                .HasForeignKey(d => d.ItemId);
            this.HasRequired(t => t.BsUnit)
                .WithMany(t => t.RmOutEmployeeDtls)
                .HasForeignKey(d => d.UnitId);
            this.HasRequired(t => t.RmOutEmployee)
                .WithMany(t => t.RmOutEmployeeDtls)
