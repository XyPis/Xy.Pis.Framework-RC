...
{
    public class DhInAdviceLongMap : EntityTypeConfiguration<DhInAdviceLong>
    {
        public DhInAdviceLongMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
