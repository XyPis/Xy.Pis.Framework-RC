...
{
    public class VwNfinfectDrug_diverMap : EntityTypeConfiguration<VwNfinfectDrug_diver>
    {
        public VwNfinfectDrug_diverMap()
        {
            // Primary Key
            this.HasKey(t => new { t.HospId, t.Code, t.ID, t.InfectTime, t.OperTime, t.OperID });
            ...
            this.ToTable("VwNfinfectDrug_diver");
