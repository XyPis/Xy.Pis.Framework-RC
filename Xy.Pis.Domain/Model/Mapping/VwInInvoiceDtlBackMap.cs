...
{
    public class VwInInvoiceDtlBackMap : EntityTypeConfiguration<VwInInvoiceDtlBack>
    {
        public VwInInvoiceDtlBackMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.ItemId, t.LocationId, t.LsMarkType, t.Totality, t.PriceIn, t.UnitId, t.DiscIn, t.DiscSelf, t.IsModiDisc, t.Amount, t.AmountPay, t.AmountSelf, t.AmountFact, t.IsPay, t.IsManual, t.LsPerform, t.IsCancel, t.FeeId, t.InvItemId, t.OperTime, t.OperId, t.ExecLocId, t.ExecOperId, t.RegOperTime, t.RegOperId, t.DoctorId, t.HospId });
            ...
            this.ToTable("VwInInvoiceDtlBack");
