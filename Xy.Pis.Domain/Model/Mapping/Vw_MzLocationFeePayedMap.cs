...
{
    public class Vw_MzLocationFeePayedMap : EntityTypeConfiguration<Vw_MzLocationFeePayed>
    {
        public Vw_MzLocationFeePayedMap()
        {
            // Primary Key
            this.HasKey(t => new { t.科室, t.日期, t.金额, t.基础分类, t.项目名称, t.规格, t.价格, t.病人ID, t.病人姓名 });
            ...
            this.ToTable("Vw_MzLocationFeePayed");
