...
{
    public class VwInHosInfoNormalMap : EntityTypeConfiguration<VwInHosInfoNormal>
    {
        public VwInHosInfoNormalMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.HospNo, t.PatID, t.InPatNo, t.Name, t.Sex, t.NTime, t.InTime, t.BloodGroup, t.City, t.Province, t.IsOversea, t.PatTypeId, t.LocIn, t.IsYbMt, t.YbRegNo, t.LsInStatus, t.OperTime, t.OperID, t.IsEndChg, t.IsCheckInCharge });
            ...
            this.ToTable("VwInHosInfoNormal");
