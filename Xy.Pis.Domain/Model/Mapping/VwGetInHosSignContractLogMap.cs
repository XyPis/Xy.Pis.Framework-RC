...
{
    public class VwGetInHosSignContractLogMap : EntityTypeConfiguration<VwGetInHosSignContractLog>
    {
        public VwGetInHosSignContractLogMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.HospId, t.Name, t.InPatNo, t.HouseRegAddress, t.PresentAddress, t.MealTypePriceIn, t.ServiceChargePriceIn, t.OutManagementType, t.LsMarriageName, t.SelfDrugPriceIn, t.SelfClothesPriceIn, t.SelfNursePriceIn, t.HosRenewId });
            ...
            this.ToTable("VwGetInHosSignContractLog");
            ...
            this.Property(t => t.LsContractStatus).HasColumnName("LsContractStatus");
        }
    }
}
