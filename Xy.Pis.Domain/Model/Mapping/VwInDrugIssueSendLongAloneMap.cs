...
{
    public class VwInDrugIssueSendLongAloneMap : EntityTypeConfiguration<VwInDrugIssueSendLongAlone>
    {
        public VwInDrugIssueSendLongAloneMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.HospNo, t.PatientName, t.NTime, t.GroupNum, t.Code, t.Name, t.Spec, t.LsMarkType, t.PriceIn, t.HospId, t.RequestId, t.ItemId, t.UnitReq, t.IsConfirm, t.IsIssued, t.IsPrint, t.AdviceId, t.ForDate, t.ListNum, t.RoomId, t.IsBack, t.LocationId, t.sex });
            ...
            this.ToTable("VwInDrugIssueSendLongAlone");
