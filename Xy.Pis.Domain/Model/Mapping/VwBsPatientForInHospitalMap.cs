...
{
    public class VwBsPatientForInHospitalMap : EntityTypeConfiguration<VwBsPatientForInHospital>
    {
        public VwBsPatientForInHospitalMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.InPatNo, t.CardNo, t.Name, t.SexName, t.Sex, t.isBaby, t.Native, t.Residence, t.PhoneWork, t.AddressWork, t.PostCodeWork, t.AreaCodeWork, t.PhoneHome, t.AddressHome, t.PostCodeHome, t.AreaCodeHome, t.MedicareNo, t.AccountNo, t.IsOversea, t.Company, t.LsMarriage, t.IdCardNo, t.BloodGroup, t.XNo, t.Sensitive, t.LinkmanName, t.LinkmanPost, t.LinkmanArea, t.LinkmanAddress, t.LinkmanPhone, t.isHouseMaster, t.LsCensus, t.Height, t.Weight, t.Circumference, t.Waistline, t.Sternline, t.LsSport, t.LsSportTime, t.LsSportType, t.LsBitHabit, t.SleepHour, t.LsSleepTrouble, t.SmokeHistory, t.DrinkHistory, t.OtherHabit, t.IsActive, t.InActiveReason, t.IconIndex, t.OperTime, t.OperID });
            ...
            this.ToTable("VwBsPatientForInHospital");
            ...
            this.Property(t => t.OuTimes).HasColumnName("OuTimes");
            this.Property(t => t.InTimes).HasColumnName("InTimes");
        }
    }
}
