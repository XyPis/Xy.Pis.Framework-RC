...
{
    public class VwInChinFeeMap : EntityTypeConfiguration<VwInChinFee>
    {
        public VwInChinFeeMap()
        {
            // Primary Key
            this.HasKey(t => new { t.病人姓名, t.卡号, t.病人ID号, t.性别, t.发票日期, t.中医治疗 });
