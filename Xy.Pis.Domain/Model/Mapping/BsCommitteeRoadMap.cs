...
{
    public class BsCommitteeRoadMap : EntityTypeConfiguration<BsCommitteeRoad>
    {
        public BsCommitteeRoadMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
