...
{
    public class Vw_ChinRecipe_Detail_PrintBMap : EntityTypeConfiguration<Vw_ChinRecipe_Detail_PrintB>
    {
        public Vw_ChinRecipe_Detail_PrintBMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.RecipeId, t.MzRegId, t.recipe_Num, t.Spec, t.Dosage, t.Totality, t.Memo, t.List_Num, t.IsCancel, t.Item_Desc, t.Price_In, t.PatientName, t.SequenceNum, t.Sex, t.AddressHome, t.RecipeTime, t.AccountNo, t.IsCharge });
            ...
            this.ToTable("Vw_ChinRecipe_Detail_PrintB");
